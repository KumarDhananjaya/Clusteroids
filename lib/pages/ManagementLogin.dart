...
class ManagementLogin extends StatefulWidget{
  const ManagementLogin({Key? key}): super(key:key);
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () {
                                  if (_formKey.currentState!.validate()) {
                                    ...
                                    if (_email == 'office' && _password == '1234') {
                                      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => CollegeManagement()));
                                    } else {
